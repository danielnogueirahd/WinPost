...
public class EmpresaService {
	...
	public Empresa salvar(Empresa empresa) {
		...
		// O SQL Server permite vários valores "null", mas bloqueia vários valores
		// vazios ("").
	...
	public List<Empresa> listarTodas() {
        return empresaRepositorio.findByAtivoTrue();
        }
	...
	public void excluir(Long id) {
		...
		if (empresa != null) {
			empresa.setAtivo(false); // Coloca na "lixeira"
			empresaRepositorio.save(empresa); // Salva a alteração
		}
	}
}