...
public class EmpresaControle {
    ...
    public ModelAndView remover(@PathVariable("id") Long id, RedirectAttributes attributes) {
        try {
            ...
            // Se tentar apagar uma empresa que já tem utilizadores associados
            attributes.addFlashAttribute("mensagemErro", "Não é possível excluir esta empresa pois existem usuários vinculados a ela.");
        }
        return new ModelAndView("redirect:/administrativo/empresas");
    }
}